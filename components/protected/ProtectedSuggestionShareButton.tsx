...
type ProtectedSuggestionShareButtonProps = {
...
const PROTECTED_SUGGEST_SHARE_URL = "Zcashnames.com/protected/suggest";

function buildPageShareMessages() {
  return {
    general: `Suggest a name that should be protected in the Zcash Name Space at ZcashNames: ${PROTECTED_SUGGEST_SHARE_URL}. If they accept, earn $ZEC.`,
    social: `Suggest a name that should be protected in the Zcash Name Space at @ZcashNames: ${PROTECTED_SUGGEST_SHARE_URL}. If they accept, earn $ZEC.`,
  };
}

function buildSuccessShareMessages(name: string) {
  return {
    general: `I just asked ZcashNames to protect "${name}". If they accept, I'll earn $ZEC. Suggest a name that should be protected: ${PROTECTED_SUGGEST_SHARE_URL}`,
    social: `I just asked @ZcashNames to protect "${name}". If they accept, I'll earn $ZEC. Suggest a name that should be protected: ${PROTECTED_SUGGEST_SHARE_URL}`,
  };
}

export default function ProtectedSuggestionShareButton({
  buttonClassName,
  ...
  portalMenu = false,
  submittedName,
}: ProtectedSuggestionShareButtonProps) {
