            ...
            {loading ? (
              ...
              options.map((option) => (
                <button
                  ...
                  className="flex w-full items-start justify-between gap-3 rounded-xl px-3 py-2.5 text-left transition-colors hover:bg-[color-mix(in_srgb,var(--fg-heading)_10%,transparent)]"
                >
