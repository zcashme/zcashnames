...
function MenuItem({
  ...
  if (href) {
    ...
    const useExternalAnchor = external ?? !internal;
    ...
    return (
      <a
        ...
        rel={isHttpHref ? "noopener noreferrer" : undefined}
...
export function ActionDropdown({
  ...
  // Monochrome sets --verify-menu-fill to transparent for flat page surfaces; floating
  // menus need an opaque page-background fill so content underneath doesn't show through.
  const defaultMenuClassName = monochrome
    ? "border-[rgba(155,188,15,0.62)] bg-[var(--color-background)] shadow-[0_18px_40px_rgba(15,56,15,0.62)]"
...
export default function ShareDropdown({
  ...
  xMessage,
  shareUrl,
  // emailSubject remains accepted for call-site compatibility; Email is not listed in the menu.
  copyLabel = "Copy Link",
  copiedLabel = "Copied!",
  ...
  const items: ActionDropdownItem[] = [
    ...
    },
    {
      ...
      label: "WhatsApp",
      icon: <WhatsAppIcon />,
      href: buildWhatsAppShareHref(shareMessageWithLink),
    },
    {
      key: "telegram",
      label: "Telegram",
