...
export function protectedNameDecisionSubject(args: ProtectedNameDecisionEmailArgs): string {
  ...
  return `Protected name ${workflowLabel(args.workflow)} ${outcome}: ${args.name}.zec / ${args.name}.zcash`;
}
