  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        className="relative flex h-8 w-8 cursor-pointer items-center justify-center text-fg-heading transition-opacity hover:opacity-75"
      >
        <span
