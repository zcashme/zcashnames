...
export default async function ReserveinfoPostPage() {
  ...
  return <main className="w-full"><SiteRouteTitle title="Reserveinfo Post" /><ReserveinfoPostTool initialSchedule={initialSchedule} initialQueue={initialQueue} initialPreview={initialPreview} reportWindow={previewWindow} previewError={previewError} /></main>;
}
